    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "zyx.practise");
                servletContext.setInitParameter("tapestry.development-modules", "zyx.practise.services.DevelopmentModule");
